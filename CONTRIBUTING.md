# Contributing to HZB-energy-schema

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to
HZB-energy-schema. These guidelines are not strict rules.
...
The HZB-energy-schema team strives to create a
...
- Pull Requests
    ...
    - PRs should be reviewed and merged in a timely fashion by the HZB-energy-schema technical leads
...
[issues]: https://github.com/anak-velazquez/HZB-energy-schema/issues/
[pulls]: https://github.com/anak-velazquez/HZB-energy-schema/pulls/
